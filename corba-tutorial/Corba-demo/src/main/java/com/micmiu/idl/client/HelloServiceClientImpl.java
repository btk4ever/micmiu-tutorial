...
class HelloServiceClientImpl {
	...
	public void initORB(String[] args) throws Exception {
		...
		// 启用命名服务
		org.omg.CORBA.Object ncobj = orb.string_to_object("corbaloc::1.2@127.0.0.1:1234/NameService");
...
//		org.omg.CORBA.Object obj = orb.string_to_object(ior);
	 ...
	 * 测试命名服务 初始化时需要配置命名服务地址: orb.string_to_object("corbaloc::1.2@127.0.01:1234/NameService")
	 *
	 * @param args
	 */
