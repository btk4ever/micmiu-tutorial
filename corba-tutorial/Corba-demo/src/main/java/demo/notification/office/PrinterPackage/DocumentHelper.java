...
/**
 * Generated from IDL alias "Document".
 *
...
public abstract class DocumentHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DocumentHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(DocumentHelper.id(), "Document",org.omg.CORBA.ORB.init().create_string_tc(0));
				}
			}
		}
		return _type;
	...
	{
		return "IDL:demo/notification/office/Printer/Document:1.0";
	}
